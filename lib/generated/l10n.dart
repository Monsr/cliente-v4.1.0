...
class S {
  ...
  String get should_be_more_than_3_letters {
   ...
   String get should_be_more_than_4_digits {
    return Intl.message(
      'Debe ser un número mayor a 4 dígitos ',
      name: 'should_be_more_than_4_digits',
      desc: '',
      args: [],
    );
  }
  ...
  String get how_would_you_rate_this_restaurant_ {
    return Intl.message(
      '¿Cómo calificaría este restaurante?',
  ...
  String get tell_us_about_this_food {
    return Intl.message(
      'Cuéntanos sobre este restaurante',
  ...
  String get pickup_your_food_from_the_restaurant {
    return Intl.message(
      'Pasa por tu pedido al restaurante',
  ...
  String get this_food_was_added_to_cart {
    return Intl.message(
      'Esta comida fue agregada al carrito',
  ...
  String get click_to_confirm_your_address_and_pay_or_long_press {
    return Intl.message(
      'Haga clic para confirmar su dirección y pagar o mantenga presionado para editar su dirección',
  ...
  String get click_to_pay_with_your_visa_card {
    return Intl.message(
      'Haga clic para pagar con su Visa Card',
  ...
  String get click_to_pay_with_your_mastercard {
    return Intl.message(
      'Haga clic para pagar con su MasterCard',
  ...
  String get click_to_pay_with_your_paypal_account {
    return Intl.message(
      'Haga clic para pagar con su cuenta PayPal',
  ...
  String get click_to_pay_cash_on_delivery {
    return Intl.message(
      'Haga clic para pagar en la entrega',
  ...
  String get click_to_pay_on_pickup {
    return Intl.message(
      'Haga click para pagar cuando pases',
  ...
  String get deliveryAddressOutsideTheDeliveryRangeOfThisRestaurants {
    return Intl.message(
      'Dirección de entrega sale del rango de entrega de este restaurante.',
   ...
   String get checkYourDeliveryAddressInSettings {
    return Intl.message(
      'Actualiza tu ubicación en el mapa',
      name: 'checkYourDeliveryAddressInSettings',
      desc: '',
      args: [],
    );
  }
  ...
  String get thisRestaurantNotSupportDeliveryMethod {
    return Intl.message(
      'Este restaurante no tiene método de entrega',
  ...
  String get oneOrMoreFoodsInYourCartNotDeliverable {
    return Intl.message(
      'Uno o más alimentos en tu carrito no son entregables.',
  ...
  String get deliveryMethodNotAllowed {
    return Intl.message(
      'Método de entrega no disponible',
  ...
  String get clickOnTheFoodToGetMoreDetailsAboutIt {
    return Intl.message(
      '¡Click sobre la comida para ver más detalles!',
