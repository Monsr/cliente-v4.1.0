                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      Expanded(
                        child: Text(
                          "Los gastos de envio se calculan al seleccionar la direccion de entrega.",
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      if (Helper.canDelivery(_con.carts[0].food.restaurant, carts: _con.carts) && Helper.delivery)
                  ...
                  Stack(
                    ...
                    children: <Widget>[
                      SizedBox(
                        ...
                        child: FlatButton(
                          onPressed: () {
                            print("Card Buttom Item");
                            _con.goCheckout(context);
                            print("Card Buttom Item2");
                          },
