...
class PaymentMethodListItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).popAndPushNamed(this.paymentMethod.route);
        //Navigator.of(context).pushNamedAndRemoveUntil(this.paymentMethod.route, ModalRoute.withName('/Cart'));
        //Navigator.of(context).pushNamedAndRemoveUntil(this.paymentMethod.route, (Route<dynamic> route) => false);
