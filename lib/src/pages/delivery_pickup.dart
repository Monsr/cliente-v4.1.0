          ...
          children: <Widget>[
            ...
            PickUpMethodItem(
                ...
                onPressed: (paymentMethod) {
                  ...
                  if(selectPickUp){
                    Helper.delivery = false;
                    _con.calculateSubtotalWithoutFee();
                  }
                  
                  //_conCart.calculateSubtotalPickUp();
                }),
            Column(
              children: <Widget>[
                Padding(
                ...
                _con.carts.isNotEmpty && Helper.canDelivery(_con.carts[0].food.restaurant, carts: _con.carts)
                    ? DeliveryAddressesItemWidget(
                        ...
                        onPressed: (Address _address) {
                          if ((_con.deliveryAddress.id == null || _con.deliveryAddress.id == 'null') && !_con.deliveryAddress.isDefault) {
