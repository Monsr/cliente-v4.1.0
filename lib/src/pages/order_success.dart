...
class OrderSuccessWidget extends StatefulWidget {
  ...
  OrderSuccessWidget({Key key, this.order, this.routeArgument}) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(
                              ...
                              child: FlatButton(
                                onPressed: () {
                                  // navegacion a la pagina de animacion del status del pedido

                                  //debugPrint("ID");
                                //Navigator.of(context).pushNamed('/Tracking', arguments: RouteArgument(id: "207", orderStatusGif: "preparando"));
